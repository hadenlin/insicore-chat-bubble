<?php
/**
 * "Visibility" modal ??shown when the user clicks Save & Publish.
 * Contains the same display-rule repeater UI that was previously a tab.
 *
...
?>
<div class="pcb-modal-overlay" id="pcb-visibility-modal" aria-hidden="true">
    <div class="pcb-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="pcb-vis-modal-title">
        <div class="pcb-modal-header">
            <div>
                <h3 id="pcb-vis-modal-title"><?php esc_html_e( 'Where should the bubble appear?', 'insicore-chat-bubble' ); ?></h3>
                <p class="pcb-modal-subtitle"><?php esc_html_e( 'Leave empty to show on every page. Add rules to limit where it shows.', 'insicore-chat-bubble' ); ?></p>
            </div>
            <button type="button" class="pcb-modal-close" id="pcb-vis-modal-close" aria-label="<?php esc_attr_e( 'Close', 'insicore-chat-bubble' ); ?>">&times;</button>
        </div>

        <div class="pcb-modal-body">
            <div id="pcb-rule-repeater" class="pcb-vis-rules"></div>

            <div class="pcb-add-rule-wrap">
        ...
        <div class="pcb-modal-footer">
            <button type="button" class="pcb-btn-ghost" id="pcb-vis-modal-cancel"><?php esc_html_e( 'Cancel', 'insicore-chat-bubble' ); ?></button>
            <button type="button" class="pcb-btn-primary" id="pcb-vis-modal-save">
